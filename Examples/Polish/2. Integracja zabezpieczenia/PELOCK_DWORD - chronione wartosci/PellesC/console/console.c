...
//
// Dla Pelles C nalezy ustawic dodatkowe flagi kompilatora "-Ze -Zx -Go"
//
// Wersja         : PELock v2.0
// Jezyk          : C/C++
...
int main(int argc, char *argv[])
{
	...
	MessageBox(NULL, "Chronione wartoœci PELock'a w akcji", "Hello world :)", PELOCK_DWORD( MB_ICONINFORMATION ) );
