...
BOOL CPelock_expirationDlg::OnInitDialog()
{
	...
	case myPELock.PELOCK_TRIAL_ACTIVE:
		...
		m_Info.Format("Application v1.0 beta, wygasnie w dniu %u/%u/%u", stExpirationDate.wDay, stExpirationDate.wMonth, stExpirationDate.wYear);
		break;

	case myPELock.PELOCK_TRIAL_EXPIRED:

		m_Info = "Ta aplikacja wygasla i bedzie zamknieta!";
		break;

	case myPELock.PELOCK_TRIAL_ABSENT:
	default:

		m_Info = "Application v1.0 pelna wersja";
		break;
	}
