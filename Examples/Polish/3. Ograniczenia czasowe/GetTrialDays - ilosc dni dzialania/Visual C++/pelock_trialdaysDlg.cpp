...
BOOL CPelock_trialdaysDlg::OnInitDialog()
{
	...
	case myPELock.PELOCK_TRIAL_ACTIVE:
		...
		if (dwLeftDays == 0)
		{
			m_TrialInfo = "To ostatni dzien okresu testowego.";
		}
		else
		{
			m_TrialInfo.Format("Wersja ograniczona, pozostalo %u dni z %u.", dwLeftDays, dwTotalDays);
		}
	...
	case myPELock.PELOCK_TRIAL_EXPIRED:
		...
		m_TrialInfo = "Ta aplikacja wygasla i zostanie zamknieta!";
	...
	default:
		...
		m_TrialInfo = "Brak ograniczen czasowych lub aplikacja zostala zarejestrowana.";
