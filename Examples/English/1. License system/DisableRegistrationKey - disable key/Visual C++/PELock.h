...
static __declspec(noinline) DWORD GetPELockDWORD(DWORD dwValue, DWORD dwMagic1 = 0x11223344, DWORD dwMagic2 = 0x44332211)
#endif

#endif

#ifndef GET_PELOCK_DWORD
static DWORD GetPELockDWORD(DWORD dwValue, DWORD dwMagic1 = 0x11223344, DWORD dwMagic2 = 0x44332211)
#endif
{
...
#define PELOCK_DWORD(dwValue) (GetPELockDWORD(dwValue))
...
public:
	...
	DWORD PELOCK_DWORD(DWORD dwValue, DWORD dwMagic1 = 0x11223344, DWORD dwMagic2 = 0x44332211);
	#endif
};
