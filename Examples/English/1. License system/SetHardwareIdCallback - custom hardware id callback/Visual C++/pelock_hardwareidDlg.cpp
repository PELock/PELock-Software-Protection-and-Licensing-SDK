...
BOOL CPelock_hardwareidDlg::OnInitDialog()
{
	...
	//
	// demo markers are required to be able to read hardware id
	//
	DEMO_START
	...
	//
	// read hardware id, dont put it between DEMO markers, because
	// this code should be available even without license (for
	// unregistered users)
	//
	CRYPT_START
