...
begin
  ...
  // time trial active
  //
  PELOCK_TRIAL_ACTIVE : lblTrialInfo.Caption := 'You have ' + IntToStr(dwExecutionsLeft) + ' more executions left (out of ' + IntToStr(dwExecutionsTotal) + ') to test our software';
