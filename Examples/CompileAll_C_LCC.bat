...
set CONSOLE_SCRIPT=make_console_lcc.bat
set GUI_SCRIPT=make_gui_lcc.bat
...
call :compile_go "%EXAMPLE%\Polish\1. System licencyjny\GetKeyRunningTime - czas wykorzystania klucza\C\console\" "%CONSOLE_SCRIPT%"
call :compile_go "%EXAMPLE%\Polish\1. System licencyjny\GetKeyRunningTime - czas wykorzystania klucza\C\gui\" "%GUI_SCRIPT%"
